...
ObservedStateDelta RealitySampler::Measure(const SystemSignalSnapshot& before, const SystemSignalSnapshot& after) {
    ObservedStateDelta delta = {};
    
    // Pure subtraction / comparison
    // No learning, no smoothing, no interpretation.
